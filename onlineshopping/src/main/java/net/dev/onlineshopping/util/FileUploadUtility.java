package net.dev.onlineshopping.util;
...
public class FileUploadUtility {
	...
	private static final String ABS_PATH = "C:/Users/ryan/git/online-shopping/onlineshopping/src/main/webapp/assets/images/";
	...
	{				
		...
		try {
			...
			file.transferTo(new File(REAL_PATH + code + "." + ext));
			file.transferTo(new File(ABS_PATH + code + "." + ext));
	...
	public static boolean deleteFile(String code) 
	{		
		
		File file = new File(ABS_PATH + code + ".jpg");
