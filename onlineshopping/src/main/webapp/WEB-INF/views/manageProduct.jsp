				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="brand" name="brand" id="brand"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" name="unitPrice"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="quantity" name="quantity"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:select path="categoryId" name="categoryId" id="categoryId"
